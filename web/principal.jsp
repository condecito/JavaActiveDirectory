...
<%
    ...
    if (!usuario.equals("") && !pass.equals("")) {
        ...
        String dn = usuario.toUpperCase()+"@"+dominio;    //"CN=Person,CN=Schema,CN=Configuration,DC="+dominio+",DC=HN";//dominio + "\\" + usuario;//se construlle con el dominio\\usuario CN=Person,CN=Schema,CN=Configuration,DC=XXXX,DC=NN
